  ...
  const cards = [
    {
      ...
      icon: "/Servicesimages/nietzche.svg",
    },
    {
      name: "Brooklyn Simmons",
      state: "Texas,US",
      src: "/Servicesimages/brooklyn.jpg",
      ...
      icon: "/Servicesimages/lightbox.svg",
    },
    {
      ...
      icon: "/Servicesimages/global.svg",
    },

    {
      name: "Savannah Nguyen",
      state: "Georgia,US",
      src: "/Servicesimages/savannah.jpg",
    ...
    <div>
      <div className="overflow-hidden flex-col flex gap-5 relative">
        <div className={`flex flex-col gap-8 `}>
          <div
            className={`flex gap-5 md:gap-3

lg:gap-8 px-2 transition-transform duration-300 ease-in-out`}
            style={{
                ...
                <div>
                  <div className="flex flex-col gap-3 lg:flex-row ">
                    ...
                    <div className="border border-gray-400 p-4 lg:p-10">
                      ...
                      <p className="text-[15px] mt-4 text-gray-700 lg:text-xl lg:mt-5 ">
                        {card.review}
                      </p>
                    </div>
                  </div>
                  <div className="lg:flex space-x-1 lg:mt-4">
                    <div className="hidden lg:block ">
                      <img src={card.icon} alt={card.icon} className="" />
                    </div>
